...
namespace ArtyParty.Entities
{
    public partial class Enemy : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public string EditModeType { get; set; } = "ArtyParty.Entities.Enemy";
                ...
                {
                    {
                        ...
                        FlatRedBall.IO.Csv.CsvFileManager.CsvDeserializeDictionary<System.String, ArtyParty.DataTypes.PlatformerValues>("content/entities/enemy/platformervaluesstatic.csv", temporaryCsvObject, FlatRedBall.IO.Csv.DuplicateDictionaryEntryBehavior.Replace);
