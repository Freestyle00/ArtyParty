...
namespace ArtyParty.Screens
{
    public partial class Level1 : GameScreen
    {
        ...
        #endif
        protected static ArtyParty.GumRuntimes.Level1GumRuntime Level1Gum;
        protected static FlatRedBall.TileGraphics.LayeredTileMap Level1Map;
        
        ArtyParty.FormsControls.Screens.Level1GumForms Forms;
        ArtyParty.GumRuntimes.Level1GumRuntime GumScreen;
        public Level1 () 
        	: base ()
        {
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            ArtyParty.Screens.GameScreen.LoadStaticContent(contentManagerName);
            ...
            #endif
            if(Level1Gum == null) Level1Gum = (ArtyParty.GumRuntimes.Level1GumRuntime)GumRuntime.ElementSaveExtensions.CreateGueForElement(Gum.Managers.ObjectFinder.Self.GetScreen("Level1Gum"), true);
