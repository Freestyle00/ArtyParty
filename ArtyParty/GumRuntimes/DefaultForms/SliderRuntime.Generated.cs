    ...
    {
        public partial class SliderRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.SliderRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,ArtyParty.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public ArtyParty.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as ArtyParty.GumRuntimes.ContainerRuntime;
