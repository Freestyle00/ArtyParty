    ...
    {
        public partial class ComboBoxRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            NineSliceInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentComboBoxCategoryState)
                        {
                            ...
                            case  ComboBoxCategory.Disabled:
                                NineSliceInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                NineSliceInstance.Blue = 255;
                                NineSliceInstance.Green = 255;
                                NineSliceInstance.Red = 255;
                            ...
                            case  ComboBoxCategory.Highlighted:
                                NineSliceInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateFirstValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory NineSliceInstanceCurrentColorCategoryStateSecondValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory fromState,ArtyParty.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArtyParty.GumRuntimes.DefaultForms.ListBoxRuntime ListBoxInstance { get; set; }
            public ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime NineSliceInstance { get; set; }
            public ArtyParty.GumRuntimes.TextRuntime TextInstance { get; set; }
            public ArtyParty.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as ArtyParty.GumRuntimes.DefaultForms.ListBoxRuntime;
                NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as ArtyParty.GumRuntimes.TextRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as ArtyParty.GumRuntimes.SpriteRuntime;
