    ...
    {
        public partial class ScrollBarRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                            Height = 384f;
                            Width = 36f;
                            X = 0f;
                            Y = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,ArtyParty.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArtyParty.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            public ArtyParty.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            public ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public ArtyParty.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            public ArtyParty.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            public ArtyParty.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as ArtyParty.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as ArtyParty.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as ArtyParty.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as ArtyParty.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as ArtyParty.GumRuntimes.ContainerRuntime;
