    ...
    {
        public partial class DialogBoxRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            ContinueIndicatorInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                            Width = 540f;
                            X = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory ContinueIndicatorInstanceCurrentColorCategoryStateFirstValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory ContinueIndicatorInstanceCurrentColorCategoryStateSecondValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ContinueIndicatorInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ContinueIndicatorInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.DialogBoxRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.DialogBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public ArtyParty.GumRuntimes.TextRuntime ContinueIndicatorInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                ContinueIndicatorInstance = this.GetGraphicalUiElementByName("ContinueIndicatorInstance") as ArtyParty.GumRuntimes.TextRuntime;
