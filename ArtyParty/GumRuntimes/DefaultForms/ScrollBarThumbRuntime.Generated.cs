    ...
    {
        public partial class ScrollBarThumbRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            BackgroundInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Blue;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime.ButtonCategory fromState,ArtyParty.GumRuntimes.DefaultForms.ScrollBarThumbRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
