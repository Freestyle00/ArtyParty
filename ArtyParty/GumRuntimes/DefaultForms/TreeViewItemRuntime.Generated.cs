    ...
    {
        public partial class TreeViewItemRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public ArtyParty.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime ToggleButtonInstance { get; set; }
            public ArtyParty.GumRuntimes.DefaultForms.ListBoxItemRuntime ListBoxItemInstance { get; set; }
            ...
            {
                ToggleButtonInstance = this.GetGraphicalUiElementByName("ToggleButtonInstance") as ArtyParty.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime;
                ListBoxItemInstance = this.GetGraphicalUiElementByName("ListBoxItemInstance") as ArtyParty.GumRuntimes.DefaultForms.ListBoxItemRuntime;
