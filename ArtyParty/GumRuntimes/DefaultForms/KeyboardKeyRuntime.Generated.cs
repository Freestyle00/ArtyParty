    ...
    {
        public partial class KeyboardKeyRuntime : ArtyParty.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                            Height = 20f;
                            Width = 20f;
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentButtonCategoryState)
                        {
                            case  ButtonCategory.Enabled:
                                KeyBackground.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                KeyBackground.CurrentVariableState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
                            case  ButtonCategory.Disabled:
                                KeyBackground.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                KeyBackground.CurrentVariableState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                break;
                            case  ButtonCategory.Highlighted:
                                KeyBackground.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                KeyBackground.CurrentVariableState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
                            case  ButtonCategory.Pushed:
                                KeyBackground.CurrentColorCategoryState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                KeyBackground.CurrentVariableState = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                                TextInstance.CurrentColorCategoryState = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                                break;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateFirstValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateSecondValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        TextInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
            ...
            public void InterpolateBetween (ButtonCategory firstState, ButtonCategory secondState, float interpolationValue) 
            {
                ...
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory KeyBackgroundCurrentColorCategoryStateFirstValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory KeyBackgroundCurrentColorCategoryStateSecondValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                bool setKeyBackgroundCurrentVariableStateFirstValue = false;
                bool setKeyBackgroundCurrentVariableStateSecondValue = false;
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState KeyBackgroundCurrentVariableStateFirstValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState KeyBackgroundCurrentVariableStateSecondValue= ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                bool setTextInstanceCurrentColorCategoryStateFirstValue = false;
                bool setTextInstanceCurrentColorCategoryStateSecondValue = false;
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateFirstValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                ArtyParty.GumRuntimes.TextRuntime.ColorCategory TextInstanceCurrentColorCategoryStateSecondValue= ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                switch(firstState)
                {
                    case  ButtonCategory.Enabled:
                        ...
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ButtonCategory.Disabled:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        break;
                    case  ButtonCategory.Highlighted:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                    ...
                    case  ButtonCategory.Pushed:
                        setKeyBackgroundCurrentColorCategoryStateFirstValue = true;
                        KeyBackgroundCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        setKeyBackgroundCurrentVariableStateFirstValue = true;
                        KeyBackgroundCurrentVariableStateFirstValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateFirstValue = true;
                        TextInstanceCurrentColorCategoryStateFirstValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  ButtonCategory.Enabled:
                        ...
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                        break;
                    case  ButtonCategory.Disabled:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Gray;
                        break;
                    case  ButtonCategory.Highlighted:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
                    ...
                    case  ButtonCategory.Pushed:
                        setKeyBackgroundCurrentColorCategoryStateSecondValue = true;
                        KeyBackgroundCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        setKeyBackgroundCurrentVariableStateSecondValue = true;
                        KeyBackgroundCurrentVariableStateSecondValue = ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime.VariableState.Default;
                        setTextInstanceCurrentColorCategoryStateSecondValue = true;
                        TextInstanceCurrentColorCategoryStateSecondValue = ArtyParty.GumRuntimes.TextRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.KeyboardKeyRuntime.VariableState fromState,ArtyParty.GumRuntimes.DefaultForms.KeyboardKeyRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ArtyParty.GumRuntimes.DefaultForms.KeyboardKeyRuntime.ButtonCategory fromState,ArtyParty.GumRuntimes.DefaultForms.KeyboardKeyRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime KeyBackground { get; set; }
            public ArtyParty.GumRuntimes.TextRuntime TextInstance { get; set; }
            public string Text
            {
                get
                {
            ...
            {
                KeyBackground = this.GetGraphicalUiElementByName("KeyBackground") as ArtyParty.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as ArtyParty.GumRuntimes.TextRuntime;
